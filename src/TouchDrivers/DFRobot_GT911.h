...
// Maximum x-coordinate output 0x0140 = 320
// Maximum y-coordinate output 0x01E0 = 480
// 0x8047 ~ 0x80FE 168 registers
// 0x80FF configuration information check, the complement code of the byte sum of 0x8047 ~ 0x80FE
// 0x8100 configuration update flag
// Array organization
// 1. Register start address 0x8047
// 2. Number of data 0x00BA
// 0 register digits, 1 the digits of data stored in each register 16bit-reg 8bit-data
...
1,
0x80, 0x47, 
0x00, 0xBA,//(Register start address 0x8047, data number 0x00BA)
