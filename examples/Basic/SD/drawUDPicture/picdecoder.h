/**
 * @brief 可以显示16bit 24bit 和32bit的BMP和JFIF格式的JPEG/JPG图片  Can display 16bit 24bit and 32bit BMP and JFIF format JPEG / JPG pictures
 */ 
...
//使用M0才可打开这个宏，打开后M0读内置U盘的图片 Only use M0 to open this macro. After opening, M0 reads the pictures of the built-in U disk
#define ENABLE_UD
#ifdef ENABLE_UD
#define useUD
#endif
