/**
 * @brief Display 16bit 24bit and 32bit BMP and JFIF format JPEG / JPG pictures
 */
...
typedef  struct
{
  ...
  int32_t  biXPelsPerMeter ;      //The horizontal resolution, expressed in pixels / meter
  int32_t  biYPelsPerMeter ;      //The vertical resolution, expressed in pixels / meter
