...
/*!
 * @file bitmap.ino
 * @brief draws monochrome, color, and grayscale images based on the image array generated by the bitmap software. The main control requires 40000 bytes of dynamic memory. FireBeetle-ESP8266 and FireBeetle-ESP32 can run. The project uses nearly 380,000 words Festival
 * @n The motherboards supported by this example are FireBeetle-ESP32, FireBeetle-ESP8266, FireBeetle-M0
 * @copyright Copyright (c) 2010 DFRobot Co. Ltd (http://www.dfrobot.com)
 * @licence The MIT License (MIT)
 * @author [YeHangYu] (hangyu.ye@dfrobot.com)
 * @version V0.1
